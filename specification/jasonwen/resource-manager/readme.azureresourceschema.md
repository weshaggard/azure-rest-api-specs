...
batch:
  ...
  - tag: schema-testbase-2022-06-01-preview
```
...
input-file:
  - Microsoft.JasonWenTestBase/preview/2020-12-16-preview/testbase.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.JasonWenTestBase/preview/2021-09-01-preview/testbase.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.JasonWenTestBase/stable/2021-09-01/testbase.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.JasonWenTestBase/stable/2021-12-01/testbase.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.JasonWenTestBase/preview/2022-03-01-preview/testbase.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.JasonWenTestBase/preview/2022-04-01-preview/testbase.json
```

### Tag: schema-testbase-2022-06-01-preview and azureresourceschema

``` yaml $(tag) == 'schema-testbase-2022-06-01-preview' && $(azureresourceschema)
output-folder: $(azureresourceschema-folder)/schemas
# all the input files in this apiVersion
input-file:
  - Microsoft.JasonWenTestBase/preview/2022-06-01-preview/testbase.json
```