...
These settings apply only when `--tag=package-2021-08-22-preview` is specified on the command line.

```yaml $(tag) == 'package-2021-08-22-preview'
input-file:
  - Microsoft.CloudSan/preview/2021-08-22-preview/cloudsan.json
```
