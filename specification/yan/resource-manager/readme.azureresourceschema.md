...
input-file:
  - Microsoft.YanTest/preview/2020-12-16-preview/testbase.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.YanTest/preview/2021-09-01-preview/testbase.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.YanTest/stable/2021-09-01/testbase.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.YanTest/stable/2021-12-01/testbase.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.YanTest/preview/2022-03-01-preview/testbase.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.YanTest/preview/2022-04-01-preview/testbase.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.YanTest/preview/2022-05-01-preview/testbase.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.YanTest/preview/2022-08-01-preview/testbase.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.YanTest/preview/2022-08-15-preview/testbase.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.YanTest/preview/2022-09-15-preview/testbase.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.YanTest/preview/2022-10-15-preview/testbase.json
  - Microsoft.YanTest/preview/2022-10-15-preview/draftpackage.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.YanTest/preview/2022-11-01-preview/testbase.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.YanTest/preview/2022-11-15-preview/testbase.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.YanTest/preview/2022-12-01-preview/testbase.json
  - Microsoft.YanTest/preview/2022-12-01-preview/draftpackage.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.YanTest/preview/2023-01-01-preview/testbase.json
  - Microsoft.YanTest/preview/2023-01-01-preview/draftpackage.json
  - Microsoft.YanTest/preview/2023-01-01-preview/actionrequest.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.YanTest/preview/2023-01-05-preview/testbase.json
  - Microsoft.YanTest/preview/2023-01-05-preview/draftpackage.json
  - Microsoft.YanTest/preview/2023-01-05-preview/testconfiguration.json
```
