...
This is the AutoRest configuration file for aquarius.
...
These are the global settings for the aquarius.
...
``` yaml $(tag) == 'package-2022-01-26'
input-file:
  - Microsoft.GraphDB/preview/2022-01-26/aquarius.json
```
