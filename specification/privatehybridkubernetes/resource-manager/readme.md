...
input-file:
  - Private.Kubernetes/preview/2023-11-01-preview/connectedClusters.json
```
...
input-file:
- Private.Kubernetes/preview/2020-01-01-preview/connectedClusters.json
```
...
input-file:
- Private.Kubernetes/preview/2021-04-01-preview/connectedClusters.json
```
...
input-file:
- Private.Kubernetes/stable/2021-03-01/connectedClusters.json
```
...
input-file:
- Private.Kubernetes/stable/2021-10-01/connectedClusters.json
```
...
input-file:
- Private.Kubernetes/preview/2022-05-01-preview/connectedClusters.json
```
