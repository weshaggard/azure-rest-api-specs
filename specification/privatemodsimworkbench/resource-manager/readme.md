# privatemodsimworkbench

> see https://aka.ms/autorest

This is the AutoRest configuration file for privatemodsimworkbench.
...
These are the global settings for the privatemodsimworkbench.
...
swagger-to-sdk:
  ...
  - repo: azure-resource-manager-schemas
    after_scripts:
      - node sdkauto_afterscript.js privatemodsimworkbench/resource-manager
```
## Az
