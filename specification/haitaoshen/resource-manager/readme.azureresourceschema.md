...
input-file:
  - Microsoft.Haitaoshen/preview/2020-12-16-preview/testbase.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.Haitaoshen/preview/2021-09-01-preview/testbase.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.Haitaoshen/stable/2021-09-01/testbase.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.Haitaoshen/stable/2021-12-01/testbase.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.Haitaoshen/preview/2022-03-01-preview/testbase.json
```
...
# all the input files in this apiVersion
input-file:
  - Microsoft.Haitaoshen/preview/2022-04-01-preview/testbase.json
```