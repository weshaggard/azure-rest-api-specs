...
namespace Microsoft.Throttling.Service.Models
{
    ...
    {
        /// <summary>
        /// Copy the properties of this AccountProperties to another AccountProperties
        /// </summary>
        ...
        public static void CopyTo(this AccountProperties source, AccountProperties target, CopySettings copySettings = CopySettings.UsePutSemantics)
        {
            var helper = new AccountPropertiesCopyHelper();
            switch (copySettings)
            {
