...
namespace Microsoft.Throttling.Service.Models
{
    ...
    {
        /// <summary>
        /// Copy the properties of this Account to another Account
        /// </summary>
        ...
        public static void CopyTo(this Account source, Account target, CopySettings copySettings = CopySettings.UsePutSemantics)
        {
            var helper = new AccountCopyHelper();
            switch (copySettings)
            {
