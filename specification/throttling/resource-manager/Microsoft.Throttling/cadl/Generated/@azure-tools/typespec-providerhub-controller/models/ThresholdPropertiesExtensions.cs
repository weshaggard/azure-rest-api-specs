...
namespace Microsoft.Throttling.Service.Models
{
    ...
    /// </summary>
    public static class ThresholdPropertiesExtensions
    {
        /// <summary>
        /// Copy the properties of this ThresholdProperties to another ThresholdProperties
        /// </summary>
        ...
        public static void CopyTo(this ThresholdProperties source, ThresholdProperties target, CopySettings copySettings = CopySettings.UsePutSemantics)
        {
            var helper = new ThresholdPropertiesCopyHelper();
            switch (copySettings)
            {
