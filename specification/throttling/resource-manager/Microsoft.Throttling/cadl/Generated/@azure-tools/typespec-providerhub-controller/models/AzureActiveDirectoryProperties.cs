...
namespace Microsoft.Throttling.Service.Models
{
    ...
    /// </summary>
    public partial class AzureActiveDirectoryProperties : ISerializationTracker
    {
        ...
        /// <summary>
        /// Initializes a new instance of the AzureActiveDirectoryProperties class.
        /// </summary>
        public AzureActiveDirectoryProperties()
        {
            OnBeforeInitialize();
            OnAfterInitialize();
        }
        ...
        /// <summary>
        /// List of permitted user-assigned managed identities
        /// </summary>
